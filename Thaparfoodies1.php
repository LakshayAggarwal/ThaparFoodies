...
<!-- 
	  ...
	  <a href="file:///F:/Project/thaparfoodies/Thaparfoodies1.html">
	  <img class="img-responsive" style="max-width:210px; margin-top: 0px;" alt="Thaparfoodies" src="title.png" width="580px" height="160px"/>
          ...
          <i class="fa fa-2x fa-sign-in"></i><sup> Sign In</sup></a>
        </li>
                    ...
                    <div class="block">
						...
						<form action="feedback.php" method="post" >
							<div class="form-group wow fadeInDown" data-wow-duration="500ms" data-wow-delay="600ms">
                                <input type="text" class="form-control" id="fname" name="fname" placeholder="Write your full name here...">
                            </div>
                            <div class="form-group wow fadeInDown" data-wow-duration="500ms" data-wow-delay="800ms">
                                <input type="email" class="form-control" id="femail" name="femail" placeholder="Write your email address here...">
                            </div>
                            <div class="form-group wow fadeInDown" data-wow-duration="500ms" data-wow-delay="1000ms">
                                <textarea class="form-control" id="message" name="message" rows="3" placeholder="Write your feedback here..."></textarea> 
                            </div>
							<div class="form-group wow fadeInDown" data-wow-duration="500ms" data-wow-delay="1200ms">
                                <input type="submit" class="form-control" id="submit" name="submit" value="Send Feedback">
                            </div>
                        </form>
                    </div>
                </div><!-- .col-md-12 close -->
