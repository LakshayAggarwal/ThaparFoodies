...
<!-- 
	  ...
	  <img class="img-responsive" style="max-width:210px; margin-top: 0px;" alt="Thaparfoodies" src="title.png" width="580px" height="160px"/>
          ...
          <i class="fa fa-2x fa-sign-in"></i><sup style="font-size:10px;"> Sign In</sup></a>
        </li>
		<li><a href="signup.php">
                 <i class="glyphicon glyphicon-user"> </i>
<sup style="font-size:10px;"> Register</sup></a>
        </li>
                ...
                <div class="col-md-4">
                    <div class="block wow fadeInLeft"  data-wow-delay="200ms">
                        ...
                        <div class="info">
                            <ul>
                                <li>
                                  <h4><i class="fa fa-phone"></i>Mobile no.</h4>
                                  <p>+91-8725960954,+91-9815451405,+91-8146482033
								 </p>
                ...
                <div class="col-md-4">
                    <div class="block wow fadeInLeft"  data-wow-delay="1100ms">
                        <div class="gallary">
                            ...
                            <ul>
                                <li>
                                    <a href="#"><img src="photo-1.jpg" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="photo-2.jpg" alt=""></a>
                                </li>
                                <li>
                                    <a href="#"><img src="photo-3.jpg" alt=""></a>
                                </li>
